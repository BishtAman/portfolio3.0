...
export const BaseData = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-white text-[60px] font-extrabold max-[1255px]:text-[50px] max-[1000px]:text-[35px] max-[500px]:text-[30px]  max-[500px]:text-center max-[400px]:mx-[20px] max-[400px]:text-[29px]">
