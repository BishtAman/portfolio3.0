...
export const PlanetImage = () => {
  ...
  return (
    <Fragment>
      <motion.div
        className="drag-area absolute top-[29vh] left-[-96px]   [@media(max-width:700px)]:left-[-166px]  [@media(max-width:500px)]:left-[-156px] [@media(max-width:500px)]:w-[230px] [@media(max-width:500px)]:top-[7vh] [@media(max-width:1350px)]:top-[7vh]  -z-10"
        ref={constraintsRef}
      />
      <motion.img
        ref={ref}
        ...
        className="dragged-object absolute top-[25vh] left-[-96px] [@media(max-width:1000px)]:left-[-156px] [@media(max-width:500px)]:w-[230px]  [@media(max-width:500px)]:top-[7vh] "
        src={planet}
        alt="this is planet"
      />
    </Fragment>
